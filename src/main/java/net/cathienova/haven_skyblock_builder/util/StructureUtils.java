...
{
    public static StructureTemplate spawnStructure(ServerLevel level, BlockPos position, String islandTemplate)
    {
    ...
    public static void spawnAdditionalStructures(ServerLevel level, BlockPos position, String islandTemplate) {
