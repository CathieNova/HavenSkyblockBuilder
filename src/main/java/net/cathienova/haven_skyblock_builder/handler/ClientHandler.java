...
import net.cathienova.haven_skyblock_builder.screens.StructurePreviewRenderState;
import net.cathienova.haven_skyblock_builder.screens.StructurePreviewRenderer;
...
public class ClientHandler {
    ...
    public static void register(IEventBus modBus) {
        modBus.addListener(ClientHandler::registerPictureInPictureRenderers);
    ...
    private static void registerPictureInPictureRenderers(RegisterPictureInPictureRenderersEvent event) {
        event.register(StructurePreviewRenderState.class, StructurePreviewRenderer::new);
    }
        ...
        if (event.getNewScreen() instanceof CreateWorldScreen screen) {
            ...
            if (originalPreset != null) {
                ...
                if (originalDefaultWorldPreset.unwrapKey().equals(originalPreset.unwrapKey())) {
                    var skyblockWorldPreset = uiState.getSettings().worldgenLoadContext().lookupOrThrow(Registries.WORLD_PRESET).getOrThrow(overrideDefaultWorldPreset());
